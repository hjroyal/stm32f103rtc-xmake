...
{
    static struct QHsmVtable const vtable = { /* QMActive virtual table */
        &QMsm_init_,
        &QMsm_dispatch_
    #ifdef Q_SPY
    ...
    * However, this would pull in the QActive's vtable, which in turn will
    * pull in the code for QHsm_init_() and QHsm_dispatch_() implemetations,
