...
/*${QF::QF-pkg::readySet_dis_} .............................................*/
#ifndef Q_UNSAFE
/*! duplicate inverse storage for QF_readySet_ (QP FuSa Subsystem)
* @static @private @memberof QF
*/
...
/*==========================================================================*/
/* The following bitmasks are for the `refCtr_` attribute of the ::QTimeEvt
* struct (inherited from ::QEvt). This attribute is NOT used
* for reference counting in time events, because the QEVT_POOLID_(e)
* check for time events is zero (time events are treated as "immutable").
*/
...
/*! Helper macro to encapsulate a MISRA deviation
* @details
* This internal macro encapsulates the violation of MISRA-C:2023
* Rule 11.5(A).
*
* @trace
* - @tr{DVR-QP-MC4-R11_05}
...
/*! Helper macro to cast pointers to integers
*
* @param[in] ptr_ object pointer
*
* @returns
