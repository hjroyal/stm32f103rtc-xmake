...
/*! Preprocessor switch to disable QP FuSa Subsystem
*
* @attention
* Assertions are now a component of the QP Functional Safety (FuSa)
* Subsystem. The QP FuSa Subsystem is active by default, but can be
* turned off (**NOT RECOMMENDED**) by defining the preprocessor
* switch #Q_UNSAFE.
*/
#define Q_UNSAFE
...
#define QS_FILTER_AP_OBJ(obj_)  (QS_filter_.loc_AP = (obj_))

/*! @deprecated begin of a user QS record, instead use QS_BEGIN_ID() */
#define QS_BEGIN(rec_, obj_)                            \
    if (((QS_filter_.glb[(uint_fast8_t)(rec_) >> 3U]    \
