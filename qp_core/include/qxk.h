...
* - check the integrity of QF_readySet_ (duplicate inverse storage)
*
* @attention
...
* @private @memberof QXThread
*
* @param[in,out] act generic QActive* pointer of the thread
*                    that times out.
*/
...
* @returns
* 'true' if the semaphore has been taken and 'false' if a timeout
* occurred.
*
...
#ifdef Q_UNSAFE
/*! QXThread event queue signaling (no QP Functional Safety System) */
...
/*${QXK-impl::QXTHREAD_EQUEUE_SIGNAL_} .....................................*/
#ifndef Q_UNSAFE
/*! QXThread event queue signaling (with QP Functional Safety System) */
#define QXTHREAD_EQUEUE_SIGNAL_(me_) do { \
    if (me->super.temp.obj == QXK_PTR_CAST_(QMState*, &me->eQueue)) { \
        (void)QXThread_teDisarm_(QXTHREAD_CAST_(me)); \
        QPSet_insert(&QF_readySet_, (uint_fast8_t)me->prio); \
