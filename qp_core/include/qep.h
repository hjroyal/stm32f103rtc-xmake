...
/* private: */
    ...
    *
    * @description
    * The 8-bit `poolId_` member stores the event-pool number (in bits 0:3)
    * and the *memory marker* for integrity checking (in bits 4:7).
    * In the special case of immutable events (not from event pools)
...
*/
static inline bool QEvt_verify(QEvt const * const me) {
...
#ifndef Q_UNSAFE
    uintptr_t      uint; /*!< @private representation for QP FuSa Subsystem */
#endif
};
...
/* protected: */
    ...
    * transitions (part of QP Functional Safety (FuSa) Subsystem).
    */
    union QHsmAttr temp;
} QHsm;
...
* - check state machine integrity (QP FuSa Subsystem)
* @precondition{qep_hsm,303}
* - check event integrity (QP FuSa Subsystem)
*
* @note
...
* and the generation of the memory marker for integrity checsk in
* `QEvt.poolId_`.
*
* @usage
* @include qf_evt.c
...
/*! quick accessor to POOLID member of event e
*
...
* Unfortunately, pointer casting violates the advisory MISRA-C:2023
* Rule 11.3(R). This macro encapsulates this deviation and provides a
* descriptive name for the reason of this cast.
*
* @trace
...
* MISRA-C:2023 Rule 11.3(R). This macro helps to localize this deviation.
*
...
* pointer to ::QStateHandler, which violates MISRA:C-2023 Rule 11.1(R).
...
* pointer to ::QActionHandler, which violates MISRA:C-2023 Rule 11.1(R).
* This macro helps to localize this deviation.
*
* @trace
* - @tr{DVP-QP-MC4-D04_09A} (false-positive)
