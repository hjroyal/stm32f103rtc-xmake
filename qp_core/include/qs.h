...
/*! the only instance of the QS_filter object (Singleton) */
...
/*${QS::QS-tx::priv_} ......................................................*/
/*! the only instance of the QS_tx object (Singleton) */
...
* @param[in] delay  counter for the busy-delay loop to wait until
*                   the assertion-failure trace record is sent out.
* @details
...
#ifdef Q_UTEST
    /*! Flag indicating that QUTest event loop is running */
    bool inTestLoop;
#endif /* def Q_UTEST */
} QS_rx;
...
*
* @returns
* 'true' if a byte has been put into the buffer and 'false' otherwise.
*/
...
/* QS-specific critical section */
    ...
    /*! Internal QS macro for defining the critical section staus. */
